<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <!-- <el-upload action="/animal/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px" size="small" style="width: 90%">
        ...
        <el-form-item label="动物照片">
          <el-upload :action="url" ref="img" :on-success="handleImgUploadSuccess">
...
export default {
  ...
  data() {
    return {
      tableData: [],
      url: this.$global.baseURL + "/file/upload",
      total: 0,
      pageNum: 1,
      pageSize: 10,
      name: "",
